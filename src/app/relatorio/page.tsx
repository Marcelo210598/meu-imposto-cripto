    ...
    return (
      <div className="min-h-screen bg-muted/30 flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <div>
            <h1 className="text-2xl font-bold mb-2">Relatório IRPF é Pro</h1>
            <p className="text-muted-foreground">
              O relatório completo para declaração do Imposto de Renda está disponível apenas nos planos pagos.
              Faça upgrade e acesse agora.
            </p>
          </div>
          <div className="p-4 rounded-xl bg-primary/5 border border-primary/20 text-left space-y-2">
            ...
            <ul className="text-sm text-muted-foreground space-y-1 pl-6 list-disc">
              <li>Relatório completo de Bens e Direitos</li>
              <li>Ganho de Capital mês a mês</li>
              <li>Dados prontos para o GCAP</li>
          ...
          <div className="flex flex-col gap-3">
            <Button asChild size="lg">
              <Link href="/precos">Ver planos — a partir de R$ 29/mês</Link>
            </Button>
